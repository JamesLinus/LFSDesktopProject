...
//EXTERNC void xfwmWindowInit (xfwmWindow * win)
void xfwmWindowInit (xfwmWindow * win)
{
...
//EXTERNC gboolean xfwmWindowDeleted (xfwmWindow *win)
gboolean xfwmWindowDeleted (xfwmWindow *win)
{
