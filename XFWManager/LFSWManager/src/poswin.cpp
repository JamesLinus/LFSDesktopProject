...
poswin_widget_get_type (void)
{
    ...
    if (G_UNLIKELY (type == G_TYPE_INVALID))
    {
        ...
        type = g_type_register_static (GTK_TYPE_WINDOW, "Xfwm4PoswinWidget", &info,(GTypeFlags)0);
    }
...
poswinCreate (GdkScreen *gscr)
{
    ...
    poswin = (Poswin*)g_object_new (poswin_widget_get_type(), "type", GTK_WINDOW_POPUP, NULL);
