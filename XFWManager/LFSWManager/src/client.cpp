...
clientFree (Client *c)
{
    ...
    if (c->classhint.res_name)
    {
        XFree (c->classhint.res_name);
    }
    if (c->classhint.res_class)
    {
        XFree (c->classhint.res_class);
    }
    if (c->dialog_pid)
    {
...
clientFrame (DisplayInfo *display_info, Window w, gboolean recapture)
{
    ...
    c->classhint.res_name = NULL;
    c->classhint.res_class = NULL;
    XGetClassHint (display_info->dpy, w, &c->classhint);
...
void
clientSetOpacity (Client *c, guint opacity, guint clear, guint xxor)
{
    ScreenInfo *screen_info;
    DisplayInfo *display_info;
    guint applied;
